...
func Filesystem(path string) model.RegistryService {
...
func (b *filesystem) RegistryCreate(repo *model.Repo, in *model.Registry) error {
	return nil
}

func (b *filesystem) RegistryUpdate(repo *model.Repo, in *model.Registry) error {
	return nil
}

func (b *filesystem) RegistryDelete(repo *model.Repo, addr string) error {
	return nil
}
